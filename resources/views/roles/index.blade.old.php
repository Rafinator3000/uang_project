                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @can('role-delete')
                                ...
                                {!! Form::submit('Delete', ['class' => 'btn btn-danger',  'onsubmit' => 'deleteConfirm({{$role->id}})']) !!}
                                {!! Form::close() !!}
                            @endcan
                        </td>
                    </tr>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="{{ route('roles.destroy', $role->id) }}" id="deleteForm-{{$role->id}}" method="POST" style="display: inline-block;">
                                @csrf
                                @method('DELETE')
